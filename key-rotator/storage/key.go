...
// NewKey returns a new Key implementation, using the given Kubernetes secret
// interface for backing storage.
func NewKey(k8s k8s.SecretInterface, prioEnv string) (Key, error) { return k8sKey{k8s, prioEnv}, nil }
